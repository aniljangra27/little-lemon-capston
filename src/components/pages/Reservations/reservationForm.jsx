...
const ReservationForm = ({
  ...
  const invalidDateErrorMessage = "Please select date";
  const invalidTimeErrorMessage = "Please select time";
  const invalidOccasionErrorMessage = "Please select occasion";
